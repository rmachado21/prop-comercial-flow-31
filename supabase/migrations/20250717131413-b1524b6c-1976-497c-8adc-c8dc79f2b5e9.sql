-- Fix database issues for contested proposals system
...
-- 3. Create system user for proposal changes (avoid foreign key issues)
DO $$
BEGIN
  -- Insert a system user entry in profiles if it doesn't exist
  INSERT INTO public.profiles (id, name, email, company)
  VALUES ('00000000-0000-0000-0000-000000000000', 'Sistema', 'sistema@proposta.com', 'Sistema')
